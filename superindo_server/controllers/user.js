  ...
  try {
    ...
    const data = userTransactions?.map((userTransaction) => {
      const newData = {
        ...
        created_user: userTransaction.created_user,
        updated_user: userTransaction.updated_user,
...
exports.getUserTransaction = async (req, res) => {
  ...
  try {
    let transaction = await Transaction.findOne({
      where: { id, created_user: userId, active: true },
      include: [
        {
    ...
    const data = {
      ...
      updated_user: transaction.updated_user,
